...
def save_background(data):
    ...
    try:
        ...
        payload = {
            ...
            'siblings_json': json.dumps(normalize_siblings(data.get('siblings')), ensure_ascii=False),
        ...
        cursor.execute(
            ...
            ON DUPLICATE KEY UPDATE
                ...
                siblings_json = VALUES(siblings_json),
